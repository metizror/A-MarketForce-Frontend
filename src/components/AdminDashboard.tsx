        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <main className={`flex-1 overflow-auto relative ${activeView === 'view-company' || activeView === 'view-contact' ? '' : 'p-6'}`}>
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              ...
              <div className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-red-200/30 via-red-100/20 to-transparent rounded-full blur-3xl"></div>
              ...
              {/* Top Accent Line */}
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-red-400/30 to-transparent"></div>
            </div>
